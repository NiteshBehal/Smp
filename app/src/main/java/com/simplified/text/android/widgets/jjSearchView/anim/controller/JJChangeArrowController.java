package com.simplified.text.android.widgets.jjSearchView.anim.controller;
...
import com.simplified.text.android.widgets.jjSearchView.anim.JJBaseController;
...
//        Log.d(">>>>>", mPro+"");
    ...
    private void drawStartAnimView(Paint paint, Canvas canvas) {
        ...
        if (mPro <= 0.25) {
            ...
            canvas.drawLine(cx - cr * (mPro - 0.5f) * 4, scy - scr, scx - 0, scy - scr, paint);
        } else {
            canvas.drawLine(cx - cr, scy - scr, scx - 0, scy - scr, paint);
    ...
    private void drawNormalView(Paint paint, Canvas canvas) {
        ...
        canvas.save();
        paint.setColor(Color.parseColor("#42a4d1"));
